...
**Mid-Level Backend Engineer & DevOps** • **Founder of [Dryad Programming Language](https://github.com/Dryad-lang/Dryad)**
...
`PostgreSQL` • `MongoDB` • `Docker` • `AWS` • `Redis` • `CI/CD` • `Linux`
...
| Domínio | Repos | Domínio | Repos |
| :--- | :---: | :--- | :---: |
| 🌐 **Web Dev** | 106 | 🧪 **Data Science** | 198 |
| ⚙️ **Backend** | 118 | 🌳 **Linguagens** | 11 |
